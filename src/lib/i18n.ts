...
export const STRINGS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "chat.freeTier": "Powered by Gemini free tier. Be kind.",
    ...
    "chat.error.rate": "Slow down, archivist. Try again in an hour.",
  ...
  zh: {
    ...
    "chat.freeTier": "由 Gemini 免费额度提供支持，请节制使用。",
    ...
    "chat.error.rate": "档案员，请慢一点。一小时后再试。",
